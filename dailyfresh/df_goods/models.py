...
class Goods(BaseModel):
    ...
    # １－６之间
    goods_type_id = models.SmallIntegerField(choices=goods_type_choice,verbose_name='商品种类id')
    ...
    goods_status = models.SmallIntegerField(default=1, verbose_name='商品库存')
